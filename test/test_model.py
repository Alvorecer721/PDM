...
# generator = pipeline('text-generation', model=model, tokenizer='meta-llama/Meta-Llama-3-8B', device='cuda:0')
...
# prefix = tokenizer.decode(data[11]['prefix'])

# tokenize_fn(prefix).input_ids == data[11]['prefix']



# print("New gen: ", generator(prefix, do_sample=False, max_new_tokens=500,num_beams=1)[0]['generated_text'])

# print("######################################")
# print('############ Old gen ###############')
# print("######################################\n")

# print("Old gen: ", tokenizer.decode(data[11]['generated_suffix']))

# print("######################################")
# print('############ Reference ###############')
# print("######################################\n")
# print('Reference: ', tokenizer.decode(data[11]['true_suffix']))
